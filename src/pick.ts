/**
 * Mechanism 2: pick (mother-of-invention#1's "pick" half). Driven first in a
 * real caller, a two-principal game, and moved here once measured there.
 *
 * In that caller, listing alternatives changed nothing about what a mind chose, and
 * a stated cost changed nothing either. So on a forced turn a choice
...
export async function pick<C>(
  ...
  // In the first caller, nothing unseen to force to was the usual case: the
  // candidates were rewordings of one idea. Ask once more, told why.
